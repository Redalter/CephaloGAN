...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0.):
        ...
        coords = torch.stack(torch.meshgrid([coords_h, coords_w]))  # [2, Mh, Mw] #, indexing="ij" origin after coords_w]
...
class SwinStage(nn.Module):
    ...
    def __init__(self, dim, c2, depth=2, num_heads=4, window_size=8,
